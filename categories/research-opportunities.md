...
Research fellowships, T32 slots, summer research programs, and society-sponsored research opportunities for radiology trainees.

> See `../templates/opportunity-entry.md` for the entry format. Deadlines drift annually — verify on the sponsor's site before applying.

---

### NIH T32 Radiology Research Training Grants

- **Sponsor:** National Institutes of Health (NIH) / National Institute of Biomedical Imaging and Bioengineering (NIBIBC) / individual host institutions
- **Eligibility:** U.S. citizens or permanent residents; typically PGY-2+ diagnostic radiology residents pursuing a dedicated research year (or 2). Specific eligibility varies by host institution.
- **Deadline:** (verify annually) — institution-specific application timelines, usually 6–12 months ahead of start
...
- **Sponsor:** Radiological Society of North America (RSNA) Research & Education Foundation
...
- **Eligibility:** Medical students in North American programs interested in radiology research. RSNA student membership required (free).
- **Deadline:** (verify annually) — typically February
- **Recurrence:** Annual
- **Link:** https://www.rsna.org/research/funding-opportunities (verify path annually)
...
- **Eligibility:** Medical students or early residents (varies by award track) at participating U.S. institutions, conducting clinical research.
...
- **Sponsor:** Sarnoff Cardiovascular Research Foundation
...
### RSNA/AUR/APDR/SCARD Radiology Research Academic Fellowship (RRAF)

- **Sponsor:** RSNA, in collaboration with AUR (Association of University Radiologists), APDR (Association of Program Directors in Radiology), SCARD (Society of Chairs of Academic Radiology Departments)
- **Eligibility:** Junior radiology faculty (occasionally late-stage fellows) committed to academic careers. Some components open to senior trainees — verify per cycle.
- **Deadline:** (verify annually)
- **Recurrence:** Annual
...
### Department of Defense (DoD) Peer-Reviewed Programs — Trainee/Resident Awards

- **Sponsor:** U.S. Department of Defense Congressionally Directed Medical Research Programs (CDMRP)
...
### Society-Specific Summer Research Programs (multiple sponsors)

- **Sponsor:** Various radiology subspecialty societies (e.g., American Society of Neuroradiology, Society of Skeletal Radiology, Society of Abdominal Radiology) — check each society's research/awards page
- **Eligibility:** Typically medical students and junior residents; varies by society
- **Deadline:** (verify annually)
- **Recurrence:** Annual at participating societies
