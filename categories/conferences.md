...
Major radiology and imaging-informatics conferences. Includes abstract deadlines, registration cadence, and trainee discounts where known.

> See `../templates/opportunity-entry.md` for the entry format. Verify all dates and rates annually — conference timelines and pricing change every year.
...
- **Eligibility:** Open to all radiology professionals and trainees. RSNA membership offers reduced registration; trainee membership is free.
- **Deadline:** (verify annually) — abstracts typically due in April; meeting held the week after Thanksgiving in Chicago
- **Recurrence:** Annual (late November / early December)
...
### ACR Annual Meeting (ACR Crossroads of Radiology)
...
- **Sponsor:** American Society of Neuroradiology (ASNR)
- **Eligibility:** Open to all; ASNR membership and trainee discounts available.
- **Deadline:** (verify annually) — abstracts typically due in fall; meeting in spring
...
- **Eligibility:** Open to all; SAR resident/fellow membership provides discounts.
- **Deadline:** (verify annually) — abstracts typically due late fall; meeting in spring
...
- **Sponsor:** Society of Interventional Radiology (SIR)
- **Eligibility:** Open to all; SIR member-in-training and trainee discounts available.
- **Deadline:** (verify annually) — abstracts typically due in fall; meeting in spring
- **Recurrence:** Annual (typically March)
...
- **Sponsor:** Society of Breast Imaging (SBI), in partnership with ACR
- **Eligibility:** Open to all; trainee discounts available
- **Deadline:** (verify annually) — meeting typically held in spring
- **Recurrence:** Annual
...
- **Eligibility:** Open to all; researchers, clinicians, trainees. Student registration tier available.
- **Deadline:** (verify annually) — paper deadlines typically in the spring; meeting in early fall
- **Recurrence:** Annual
...
- **Sponsor:** SPIE (the international society for optics and photonics)
- **Eligibility:** Open to all; student/trainee tiers available
- **Deadline:** (verify annually) — abstracts typically due in summer; meeting in February
- **Recurrence:** Annual
